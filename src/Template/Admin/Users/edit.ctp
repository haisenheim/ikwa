<h3 class="page-header">EDITION DU PROFIL DE <?= $us->name ?></h3>
<div class="content">
            ...
            <form action="<?= $this->Url->build(['action'=>'add']) ?>" class="form" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-lg-6 col-md-6 form-group">
                        ...
                        <input type="text" name="last_name" class="form-control" id="last_name" value="<?= $us->last_name ?>"/>
                    </div>
                    <div class="col-sm-12 col-lg-6 col-md-6 form-group">
                        <label for="first_name">Prenom :</label>
                        <input type="text" name="first_name" class="form-control" id="first_name" value="<?= $us->first_name ?>"/>
                    </div>
                    <div class="col-sm-12 col-lg-3 col-md-3 form-group">
                        <label for="phone">Telephone :</label>
                        <input type="tel" name="phone" class="form-control" id="phone" value="<?= $us->phone ?>"/>
                    </div>

                    <div class="col-sm-12 col-lg-4 col-md-4 form-group">
                        <label for="email">Email </label>
                        <input type="email" name="email" class="form-control" id="email" value="<?= $us->email ?>"/>
                    </div>
