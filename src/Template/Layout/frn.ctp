                                    ...
                                    <div class="row">
                                        <?php foreach($ctgs as $ctg): ?>
                                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
                                                <a href="<?= $this->Url->build(['controller'=>'Categories','action'=>'view',$ctg->id]) ?>" class="connection-item"><img src="<?= $this->Url->image($ctg->imageUri) ?>" alt="" > <span style="font-size: 11px"><?= $ctg->name ?></span></a>
                                            </div>
                                        <?php endforeach; ?>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link <?= $this->request->getParam('controller')=='Orders'?'active':'' ?>" href="<?= $this->Url->build(['controller'=>'Orders','action'=>'index']) ?>"><i class="fa fa-fw fa-shopping-cart"></i>COMMANDES</a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link <?= $this->request->getParam('controller')=='Listes'?'active':'' ?>" href="<?= $this->Url->build(['controller'=>'Listes','action'=>'index']) ?>"><i class="fa fa-fw fa-list-alt"></i>LISTE DES PRIX</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link <?= in_array($this->request->getParam('controller'), ['Offres','Categories','Users'])?'active':'' ?>" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-cogs"></i>PARAMETRES</a>
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?= $this->Url->build(['controller'=>'Offres','action'=>'index']) ?>"><i class="fa fa-fw fa-tasks"></i>LISTE DES ARTICLES</a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="nav-link" href="<?= $this->Url->build(['controller'=>'Categories','action'=>'index']) ?>"><i class="fa fa-fw fa-list-ul"></i>CATEGORIES</a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="nav-link" href="<?= $this->Url->build(['controller'=>'Users','action'=>'index']) ?>"><i class="fa fa-fw fa-users"></i>CAISSIERS</a>
                                        </li>
                ...
                <div class="row" style="background-color: #00796b">
                    <div  class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h1 style="padding: 10px 0 0 0" class="pageheader-title text-center"><span style="color: #FFFFFF; font-family: cakefont; font-weight: 900; text-shadow: 1px 2px 1px #000"><?= $frn->name ?></span> </h1>
                        </div>
                    </div>
                </div>
