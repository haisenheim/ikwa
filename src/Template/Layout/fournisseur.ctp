    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark" style="background-color: #000000 !important;">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item"><a href="<?= $this->Url->build(['controller'=>'Orders','action'=>'index']) ?>" class="nav-link"><i class="fa fa-shopping-cart"></i> COMMANDES</a></li>
                <li class="nav-item"><a href="<?= $this->Url->build(['controller'=>'Listes','action'=>'index']) ?>" class="nav-link"><i class="fa fa-donate"></i> LISTES DE PRIX</a></li>
                <li class="nav-item"><a href="<?= $this->Url->build(['controller'=>'Offres','action'=>'index']) ?>" class="nav-link"><i class="fa fa-list-alt"></i> ARTICLES</a></li>
                <li class="nav-item"><a href="<?= $this->Url->build(['controller'=>'Categories','action'=>'index']) ?>" class="nav-link"><i class="fa fa-list"></i> CATEGORIES</a></li>
                <li class="nav-item"><a href="<?= $this->Url->build(['controller'=>'Users','action'=>'index']) ?>" class="nav-link"><i class="fa fa-user-friends"></i> CAISSIERS</a></li>
            </ul>
