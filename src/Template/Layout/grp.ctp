...
<div class="contenu">
    <nav class="navbar navbar-expand-md navbar-dark bg-dark" style="background-color: #000000 !important;">
        <a class="navbar-brand" href="#"> IKWA - <i class="fa fa-map-marker-alt"></i> <?= $grp->name ?> </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item"><a href="<?= $this->Url->build(['controller'=>'Fournisseurs','action'=>'index']) ?>" class="nav-link"><i class="fa fa-building"></i> BOUTIQUES</a></li>
                <li class="nav-item"><a href="<?= $this->Url->build(['controller'=>'Villes','action'=>'index']) ?>" class="nav-link"><i class="fa fa-university"></i> VILLES</a></li>
                <li class="nav-item"><a href="<?= $this->Url->build(['controller'=>'Users','action'=>'index']) ?>" class="nav-link"><i class="fa fa-user-friends"></i> UTILISATEURS</a></li>
            </ul>
    ...
    <div class="content" style="margin-top: 30px">
        ...
        <div class="container">
            <div class="page-header" style="background-color: #4caf50; margin: 0 -15px; padding: 5px 0">
                <h5><?= $this->Html->image($grp->imageUri?$grp->imageUri:'logo-indefini.png',['fullBase'=>true,'style'=>'max-width:50px; min-height:50px; margin:-35px 3px']) ?> <span style="margin-left:30px "><span class="" style="text-shadow: 1px 1px 2px black; color: white; font-weight: 800"><?= $grp->name ?></span> <span style="font-weight: 600; color: white; text-shadow: 1px 1px 1px; font-size: smaller">&nbsp; &nbsp;<?= $grp->address ?> &nbsp;&nbsp;<?= $grp->phone ?></span></span> <span class="page-title pull-right" style="margin-right: 30px; color: white; font-weight: 700"><?= !empty($title)?$title:'' ?></span> </h5>
            </div>
